...
本文の見出し(`^## ` と `^### `)を全件掲載。件数: `## `見出し 48件 + `### `見出し 222件 = 合計 270件(この目次自身の見出しは含まない)。

- **[L270]** R205(2026-09-19 **検査32本すべてが CI で緑になりました** — CIの第3段階・完了)
- **[L284]** R204(2026-09-19 **CIで検査が緑になりました** — 関門突破・CIの第2段階)
- **[L310]** R203(2026-09-19 `server.mjs` を python/python3 両対応にした — CIの第1段階)
- **[L317]** R197(2026-09-19 Overpass の 406 を切り分けた — **本番は正常。壊れていたのは検証環境のほう**でした)
- **[L337]** R196(2026-09-19 「Overpassが呼ばれない」謎を解いた — 犯人は測り方と回線だった)
- **[L350]** R195(2026-09-19 無料APIの規約違反を直した)
- **[L366]** R191(2026-09-19 宿の検索結果で「宿らしいもの」を上位に出す)
- **[L378]** R190(2026-09-19 宿の検索で海外の施設が出る問題)
- **[L388]** R185(2026-09-19 確認役・コード変更なし)
- **[L395]** R182(2026-09-19 確認役・コード変更なし)
- **[L406]** R176(2026-09-19 作業役が更新)
- **[L417]** R174(2026-09-19 作業役が更新)
- **[L422]** R172(2026-09-19 作業役が更新)
- **[L427]** R171(2026-09-19 作業役が更新)
- **[L432]** R170(2026-09-19 作業役が更新)
- **[L441]** R153(2026-09-19 作業役が更新)
- **[L446]** R167(2026-09-19 作業役が更新)
- **[L451]** 朝のまとめ(2026-09-18 作業役が更新)
  - [L457] 触ってみるURL(スマホでOK)
  - [L463] 5エリア化以降で何が良くなったか
  - [L474] いま決めてほしいこと(5件)
  - [L482] 直近10サイクルで何が良くなったか(提案の中身、5エリア化より前の分)
  - [L492] 夜にやったこと(上から順)
  - [L531] 朝の相談(判断が要るもの、下の節に詳細)
  - [L560] 正直に書いておくこと
- **[L566]** R33+R34 check.mjs に応答時間の記録とREADME画像のリンク検査を追加(2026-09-16)
- **[L571]** R35 観光対象でない候補の除外をOSM側にも適用 + 社寺カテゴリ誤判定の修正(2026-09-16)
  - [L576] R35 で落ちた候補の全件(before→after の差分・3エリア計10件)
- **[L593]** R30 fixture 3エリア目「道後温泉」追加(2026-09-16)
- **[L598]** R25 GitHub Actions 毎日死活チェック(2026-09-16)
- **[L604]** R23 カード画像フォールバック(2026-09-16)
- **[L609]** 2026-09-16 未明 開始
- **[L613]** サイクル記録
  - [L615] 2026-09-20 R212 `docs/CHECKS.md` を実態(32本)に合わせて直す
  - [L620] 2026-09-19 R208 デモページ2枚のリンクプレビュー(OGカード)を整える
  - [L625] 2026-09-19 R207 英語版デモページへの入口をREADMEから作る
  - [L630] 2026-09-19 R85 営業用デモページの英語版 `demo/hotel-page-en.html`
  - [L635] 2026-09-19 R161 カテゴリ減点に上限を設ける(R160 の失敗処方の撤回)
  - [L641] 2026-09-19 R160 カテゴリ減点の母数を上位40件に絞る
  - [L646] 2026-09-16 R100 カード見出しの折り返し方針統一
  - [L651] 2026-09-16 R99 `?hotel=` の緯度経度の範囲検査
  - [L656] 2026-09-16 R9 別エリア fixture(箱根)追加
  - [L661] 2026-09-16 R2 視覚QA第1回(未撮影5画面の網羅撮影と崩れ修正)
  - [L666] 2026-09-16 F1 埋め込みモード `?embed=1`
  - [L671] 2026-09-16 R1 固定データモード `?fixture=kusatsu`
  - [L676] 2026-09-16 R7 状態Bの小地図で番号ピンが重なって見えない問題を解消
  - [L681] 2026-09-16 R4 Overpass 混雑時の自動リトライと「Wikipediaだけで提案」
  - [L686] 2026-09-16 R8 密集時に番号ピンが完全に隠れる問題の根本修正
  - [L689] 2026-09-16 F2 営業用デモ `demo/hotel-page.html`
  - [L696] 2026-09-16 R3+R6 本番URL(サブパス)の入口確認と死活チェックスクリプト
  - [L701] 2026-09-16 R5 読み込み体感の計測と短縮(+F5・要約先頭の座標除去)
  - [L706] 2026-09-16 F4 エリアチップ20件拡充+右端フェード / R2-2 0件カード文言短縮
  - [L711] 2026-09-16 R36 `scripts/check-all.mjs`(全検査を1コマンドで直列実行)
  - [L716] 2026-09-16 R37 小地図の宿ピンをタップでpanTo / R11 小地図高さ180→220px(採用)
  - [L721] 2026-09-16 R44 `?q=`等ジャンプ後に宿0件なら1回だけ自動ズームアウト
  - [L726] 2026-09-16 R51 リンクチップのラベル短縮「Googleマップ」→「行き方」
  - [L731] 2026-09-16 R54 フィードカードの times に距離(m/km)を追加
  - [L745] 2026-09-16 R12 OGPメタタグ追加
  - [L751] 2026-09-16 R13 アクセシビリティ最低限(タップ44px/aria/フォーカス/reduced-motion)
  - [L757] 2026-09-16 S1 v3暫定rankの実測(草津/箱根)
  - [L762] 2026-09-16 R17 候補収集の取りこぼし調査と修正
  - [L778] 2026-09-16 R18 誤併合の修正(名前の包含だけで別施設を同一視しない)
  - [L783] 2026-09-16 F3 受動ログ(localStorage yado.passive.v1・送信なし)
  - [L788] 2026-09-16 R20 Wikipedia geosearch の50件上限を同心円3段で回避
  - [L795] 2026-09-16 R16 カードの「もっと見る」(31〜60件目の展開)
  - [L801] 2026-09-16 R22 `docs/check.mjs` にリンク切れ検査を追加
  - [L806] 2026-09-16 R10 番号バッジをタップすると小地図の該当ピンが光る
  - [L812] 2026-09-16 R15 撮影用の遅延パラメータ `?slow=osm800,wiki1500`
  - [L818] 2026-09-16 R27 Leaflet の配信元を unpkg から cdnjs へ
  - [L824] 2026-09-16 R24+R21 `?hotel=`名前なし見出し「この宿の周辺」化 + README英語1段落
  - [L830] 2026-09-16 R26 README にスクリーンショット3枚を貼る
  - [L836] 2026-09-16 R29 `?q=`/エリアチップ選択時にチップを強調
  - [L842] 2026-09-16 R32 検索候補に「最近見た宿」を見出し付きで統合
  - [L848] 2026-09-16 R31 小地図にOSM attributionが欠落していた不具合の是正
  - [L853] 2026-09-16 R38 カードの「Googleマップ」を宿→スポットの経路リンクにする
  - [L858] 2026-09-16 R41 README「仕組み」節を現状に合わせて更新(文書のみ)
  - [L863] 2026-09-16 R39 固定データバッジ + R28 残作業(`?demo=nohotels`)
  - [L868] 2026-09-16 R47 フィード末尾に「提案の作り方」の正直な注記を追加
  - [L873] 2026-09-16 R48 `?embed=1` で高さを親にpostMessage通知
  - [L878] 2026-09-16 R56 リンクチップを1段小さくして5個を1行に収める
  - [L883] 2026-09-16 R52 + R53 文書2本(パラメータ一覧表の是正 + 埋め込み手順の明文化)
  - [L888] 2026-09-16 R58 ブラウザの戻るで状態Aに戻る(history.pushState)
  - [L893] 2026-09-16 R57 + R59 カード画像のalt改善 + 検索欄クリアボタン(×)
  - [L898] 2026-09-16 R60 + R55 「もっと見る」展開後の地図注記 + check-all所要時間の記録
  - [L904] 2026-09-16 R62 縦長写真の見切れ確認と object-position の採用
  - [L909] 2026-09-16 R63 状態Aに「サンプル: 草津/箱根/道後」のデモ導線を追加
  - [L914] 2026-09-16 R61 状態Aの地図初期位置を「最近見た宿」にフォールバック
  - [L919] 2026-09-16 R67 check-all.mjs の失敗時にログをファイルへ保存
  - [L924] 2026-09-16 R68 `?embed=1&bg=` で埋め込みの背景色を指定
  - [L929] 2026-09-16 R65 selectHotel直前の地図位置を明示保存(未保存の初期位置ズレを修正)
  - [L934] 2026-09-16 R66 カードの写真タップで簡易ライトボックス
  - [L939] 2026-09-16 R69 キーボード操作の検査(check-keyboard.mjs 新規)
  - [L944] 2026-09-16 R73+R71 README に用語ミニ辞典と写真あり割合の表を追加
  - [L949] 2026-09-16 R70 `?fixture=random` + サンプル導線に「おまかせ」
  - [L954] 2026-09-16 R40 fixture 4エリア目「別府」の追加
  - [L959] 2026-09-16 R79 公共施設が除外ルールを通過して観光候補に残る件の是正
  - [L1001] 2026-09-16 R74 サンプル導線チップの2行折り返しを横スクロール化で解消
  - [L1006] 2026-09-16 R76+R19 far の4エリア実測(文書のみ)
  - [L1011] 2026-09-16 R14 fixtures の不要 OSM タグを keep-list で除去(再生成なし)
  - [L1016] 2026-09-16 R75+R78+R72 文書3件まとめ(コード変更なし)
  - [L1021] 2026-09-16 R83 カード要約なしの代替文を淡色1行で表示
  - [L1026] 2026-09-16 R93 iframeのクエリ付きリンク検査は既に対象内と実測確認(コード変更なし)
  - [L1032] 2026-09-16 R94 0件文言A/Bを統一
  - [L1036] 2026-09-16 R98 埋め込みiframeにsandbox追加
  - [L1040] 2026-09-16 R96 ライトボックスにフォーカストラップ
  - [L1044] 2026-09-16 R95 fixture再取得手順を文書化
  - [L1048] 2026-09-16 R91 READMEのdemo値一覧を修正
  - [L1052] 2026-09-16 R88 埋め込み高さ上限を実測値に
  - [L1056] 2026-09-16 R42 要約の句点打ち切り改善
  - [L1060] 2026-09-16 R43 宿ピンにツールチップ追加
  - [L1064] 2026-09-16 R45 固定データバッジに生成日付
  - [L1068] 2026-09-16 R49+R50 文書2本追加(判断課題+FIXTURES)
  - [L1072] 2026-09-16 R84 ?debug=1でスコア内訳表示
  - [L1076] 2026-09-16 R82 戻るボタンaria-label検査追加
  - [L1078] 2026-09-16 R77 もっと見るB案は不採用
  - [L1081] 2026-09-16 R87 状態Bスケルトンを撮影確認
  - [L1085] 2026-09-16 R89 check-hotelparamを高速化
  - [L1089] 2026-09-16 R101 地図タイル失敗を1行通知
  - [L1093] 2026-09-16 R97 印刷用CSSを新設
  - [L1097] 2026-09-16 R104 README英語段落を拡張
  - [L1101] 2026-09-16 R105 検索0件時に案内文表示
  - [L1105] 2026-09-16 R106 CHECKS.mdを実体と一致させ
  - [L1109] 2026-09-16 R107 初回カード描画msを検査
  - [L1113] 2026-09-16 R108 検索語の表示を20字に制限
  - [L1117] 2026-09-16 R110 受動ログに90日期限追加
  - [L1121] 2026-09-16 R109 iframe属性の一貫性検査
  - [L1125] 2026-09-16 R112 ?bg=に輝度判定を追加
  - [L1129] 2026-09-16 R113 flyToに同一view防止ガード
  - [L1133] 2026-09-16 R111 リンクのtarget/rel検査
  - [L1137] 2026-09-16 R114 日英表記ゆれの重複を救済
  - [L1141] 2026-09-16 R115 廃止施設を定義文で除外
  - [L1146] 2026-09-16 R117 他社の宿を候補から除外
  - [L1150] 2026-09-16 R118 地図の帰属表示を矩形退避
  - [L1154] 2026-09-16 R119 存在しない施設を追加除外
  - [L1158] 2026-09-16 R120+R121 現役療養所を観光提案外
  - [L1162] 2026-09-16 R123 記事なし誤表示26件を是正
  - [L1166] 2026-09-16 R124 行き止まり13件を解消
  - [L1170] 2026-09-16 R126 朝のまとめの更新とNIGHTLOGの見出し整備
  - [L1174] 2026-09-16 R127 英語名だけのカードを除去
  - [L1179] 2026-09-17 R128 進む/戻るの履歴を修復
  - [L1184] 2026-09-17 R129 横向きで提案が読めない問題を修正
  - [L1189] 2026-09-17 R130 検査サーバの共通化
  - [L1194] 2026-09-18 R131 初めて開いた人に売り文句を1行だけ見せる
  - [L1199] 2026-09-18 R132 行けない場所3件を提案から除去
  - [L1204] 2026-09-18 R2-1 検索候補と下の3行の重なり・誤タップを解消
  - [L1209] 2026-09-18 R133 単一の場所ではない索引記事(別府駅商業施設)を除外+朝の相談の古い2件を是正
  - [L1214] 2026-09-18 R92 撮影1.1GBを可逆に畳む
  - [L1219] 2026-09-18 R134 README を実装に合わせ直す
  - [L1224] 2026-09-18 R135 CHECKS.md を実装に合わせ直す
  - [L1229] 2026-09-18 R136 geo.js が運んでいた営業時間を engine が捨てず app.js で読める形にして出す
  - [L1234] 2026-09-18 R137 「公式」2文字の裏にあるドメインを見せる
  - [L1239] 2026-09-18 R139 情報ゼロ35枚の196px空箱を64pxの帯に詰める
  - [L1244] 2026-09-18 R140 同じ絵文字を2回言うだけの64px帯を畳み番号バッジをbody側へ
  - [L1249] 2026-09-18 R141 3県またぎの国立公園2枚(同一座標2602m)をカードから除外
  - [L1254] 2026-09-18 R142 固有名を持たない一般名詞だけの候補を落とす
  - [L1259] 2026-09-18 R143 動物園の「中の展示」(動物の種名)をカードから落とす
  - [L1264] 2026-09-18 R81 城崎温泉の固定データ追加(中止・日を改める)
  - [L1269] 2026-09-18 R81(2回目) 城崎温泉の固定データ追加(再び中止・原因を特定)
  - [L1274] 2026-09-18 R144 make-fixture.mjsがslim-fixtures.mjsのmain()を誤爆させていた原因を修正
  - [L1279] 2026-09-18 R81(3回目) 城崎温泉の固定データ追加(完了)
  - [L1284] 2026-09-18 R146 castle 判定を裸の「城」からタイトル末尾一致に変更(完了)
  - [L1289] 2026-09-18 R145 災害という出来事そのものの記事を定義文だけで落とす
  - [L1294] 2026-09-18 R147 extract由来のカテゴリ判定を定義文1文目だけに限定(完了)
  - [L1299] 2026-09-18 R148 「にあった」だけで廃止を述べる竹野鉱山を落とす(AND判定・完了)
  - [L1304] 2026-09-18 R149 5エリア化の取りこぼし6箇所を塞ぐ
  - [L1309] 2026-09-18 R150 死活チェックの遅い日の印を絶対しきい値に
  - [L1314] 2026-09-19 朝のまとめ整備(判断待ちが尽きたための節整理)
  - [L1319] 2026-09-19 R151 カードに「なぜこれを出したか」の1行を出す(完了)
  - [L1324] 2026-09-19 R151 カードに「なぜこれを出したか」の1行を表示
  - [L1329] 2026-09-19 R152 提案を初期5件+もっと見る10件=合計15件に絞る
  - [L1334] 2026-09-19 R155 打ち切り(MAX_MORE)を理由付きの実数に合わせる
  - [L1339] 2026-09-19 R157 カードをテーマの束にまとめて読み飛ばせるようにする
  - [L1344] 2026-09-19 R158 束の見出しと中身を一致させる(束ごとに並べ替え)
  - [L1349] 2026-09-19 R161 観光対象でない候補の除外漏れを塞ぐ(SA/PA・事故・慰霊碑)
  - [L1354] 2026-09-19 R159 地図に無い6番以降の番号バッジをやめ、飛び番号を解消する
  - [L1359] 2026-09-19 R154 座標の取得上限(colimit)を外して「使える記事」を40件→最大338件にした
  - [L1364] 2026-09-19 R162 「両方にあるのに片方扱い」の実態を実測し、親記事指しの是正と記事名の復元をした
- **[L1373]** R163 (2026-09-19) Wikipedia被リンク数で「有名さ」を順位に反映する
- **[L1390]** R164 (2026-09-19) 親記事の本文照合で「記事を持たない有名スポット」を救う
- **[L1413]** R165(2026-09-19 作業役)
- **[L1419]** R166(= ROADMAP の R125)(2026-09-19 作業役)
- **[L1432]** R168(2026-09-19 作業役)
- **[L1445]** R169 💡理由行の文言差し替え(市場調査 第10回 10-7 仕様S-1)
- **[L1451]** R173 親記事の代表画像を最も言及されている候補に配る(市場調査 第11回 11-1 A案)
- **[L1472]** R175 親記事が痩せているときだけ上位概念に昇格する(市場調査 第12回)
- **[L1501]** R177(記録上R178) check-nosummary.mjs の期待値更新(2026-09-19)
- **[L1506]** R179 本番(実ネットワーク)での実地確認(2026-09-19) ※コード無変更・確認のみ
- **[L1529]** R180 本番の体感速度を直す(2026-09-19)
- **[L1558]** R181 Overpass が落ちた回に主役が消える問題(2026-09-19)
- **[L1593]** R183 本番と固定データの食い違い2件の調査(2026-09-19)
  - [L1597] 問題1: 本番の草津1位が「草津温泉」になる → **実バグ。修正した**
  - [L1635] 問題2: キャッシュが宿をまたいで共有されない → **正常動作。修正しない**
  - [L1658] 検査
- **[L1664]** R184 古い形式のキャッシュが残っている端末で今日の改善が効かない問題(2026-09-19)
  - [L1672] 調査
  - [L1689] 対処: 値にバージョンを持たせる(案B)
  - [L1710] 検証: 古いキャッシュを再現して確認
  - [L1721] 検査
- **[L1729]** R186 R183とR185の食い違いを切り分け、本番だけ親記事が引けない原因を直した(2026-09-19)
  - [L1735] 切り分けの結果
  - [L1758] 真の原因: 住所の2番目が「道路名」だと親記事名が壊れる
  - [L1784] 裏取り
  - [L1790] 対処: 道路名を1つ飛ばす(`continue` を1行足すだけ)
  - [L1800] 検査
  - [L1806] 申し送り
  - [L1814] 追記: 本番の end-to-end 確認ができなかった理由(R186・環境制約)
- **[L1844]** R188 親記事名の導出を直した (2026-09-19)
  - [L1846] 何が問題だったか
  - [L1860] 直し方
  - [L1873] ★`titles=` にまとめる案は実測で却下した
  - [L1896] 実測結果(全国18宿・Nominatim を1req/秒で実照会)
  - [L1925] 5エリアへの影響
  - [L1932] 本番確認(localStorage クリア後)
  - [L1942] 申し送り
- **[L1950]** R189 親記事を座標から直接探すようにした (2026-09-19)
  - [L1952] 何が問題だったか
  - [L1963] ★ 追加リクエストは0回で済んだ
  - [L1980] 直し方
  - [L2000] R188 とどちらを優先するか → 座標を優先した
  - [L2006] 実測結果(全国18宿・Nominatim を1req/秒で実照会・429/504とも0件)
  - [L2037] 5エリアへの影響
  - [L2044] 本番確認(実APIで宿の座標から親記事の本文取得まで通した)
  - [L2055] 検査
- **[L2064]** R192: 本日の最終形を通しで確認(確認のみ・コード変更なし)
  - [L2069] 新コード配信の確認
  - [L2074] 検索4件(localStorageクリア後)
  - [L2085] 提案3件
  - [L2101] 429/504の有無
  - [L2107] 総合判断
- **[L2117]** R193: 観光地が密集するエリアで50秒かかる問題を切り分けた(確認のみ・コード変更なし)
  - [L2122] ★切り分けの結果: 44.5秒/51秒は「全部揃うまで」だった
  - [L2143] ★R192 の「主因は linkshere」は誤りだった
  - [L2156] `BACKLINK_SATURATE` は正常に機能している
  - [L2164] 429/504 の観測
  - [L2171] 採った対処: 何もしない
  - [L2178] 副産物: 速度ではなく「質」の問題を見つけた → R194 として起票
- **[L2184]** 2026-09-19 R194 Overpass の25秒打ち切りで OSM 候補が欠けているかを実測した
  - [L2188] 実測の方法
  - [L2198] ★結果: 3エリア3/3で打ち切られ、主役が消えていた
  - [L2216] ★R181 のキャッシュ代替は「設計どおり完全に機能」するが「初見は救えない」
  - [L2231] 採った対処: `TIMEOUT_OVERPASS_MS` 25秒 → 40秒(`geo.js`)。これ1箇所だけ
  - [L2243] 検証
  - [L2252] 残る限界(R194 の範囲外)
  - [L2257] 本番 after 実測(45a1013 配信後・新コードが配信されていることを確認してから計測)
- **[L2280]** 2026-09-19 R194b 上限を 40秒 → 60秒(R180 が下げる前の値)に戻した
  - [L2285] 本番 after 実測(773e929 配信を確認してから計測・毎回まっさらな新規コンテキスト)
  - [L2301] ★60秒でも打ち切られるエリアはあるか → **打ち切りは1回も起きなかった**
  - [L2306] ただし504(サーバ側の混雑)は別問題として残る
  - [L2318] 検証
- **[L2327]** R199: 交通拠点(バスターミナル等)、実測したら既に表示圏外だった
  - [L2331] 実測
  - [L2342] 判断
  - [L2352] 検証
  - [L2357] 2026-09-20 R213 embed-check.html に説明書き追加・README営業デモ記述を実態に統一
  - [L2361] 2026-09-20 R218 営業デモ2枚をブラウザ検査で守る(check-demo.mjs 新設・33本化)
  - [L2366] 2026-09-20 R215 JS無効時に真っ白になる問題を noscript で解消
  - [L2370] 2026-09-20 R221 JS無効時の案内(noscript)を守る検査を新設(check-noscript.mjs・34本化)
  - [L2375] 2026-09-20 R214 サイトアイコン(favicon)を4ページに追加・docs/check.mjsに判定を相乗り
  - [L2380] 2026-09-20 R222 検査がコメントアウトされたコードを本物と誤判定する穴を塞ぐ(check-bundle.mjs)
  - [L2386] 2026-09-20 R223 検査がときどき理由なく赤くなるフレークに、1回だけの自動再実行を入れる(check-all.mjs)
  - [L2392] 2026-09-20 R220 NIGHTLOG(2123行)の先頭に目次を置いて朝に読める状態にした
  - [L2397] 2026-09-20 R224 「どれだけ知られている場所か」をカードに表示した(設計思想の3本目・表示のみ)
